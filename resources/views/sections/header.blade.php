...
@if (has_nav_menu('primary_navigation'))
{{-- Small Format --}}
  <header class="block lg:hidden z-20 fixed w-full top-0 pointer-events-none overflow-visible">
    ...
    <nav id="smallMenu" class="nav-small absolute top-0 left-0 flex justify-end min-h-full min-w-full overflow-scroll invisible opacity-0 pointer-events-auto translate-x-full transition-all duration-200" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
      <div class="text-primary bg-secondary h-full w-full sm:w-[80%] p-16 sm:p-8 text-3xl font-primary uppercase">
