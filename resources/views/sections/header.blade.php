...
@if (has_nav_menu('primary_navigation'))
  <header class="block lg:hidden z-20 fixed w-[100vw] top-0">
    ...
    {{-- Small Format --}}
    <nav id="smallMenu" class="nav-small relative top-0 left-0 flex justify-end h-[100vh] invisible opacity-0 pointer-events-none translate-x-full transition-all duration-200" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
