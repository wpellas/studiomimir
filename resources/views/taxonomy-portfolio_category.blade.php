    ...
    <div class="w-full lg:w-lg pt-8">
        ...
        <li class="block lg:hidden">
            <a href="{{get_the_post_thumbnail_url()}}" target="_blank">
                <img class="h-full w-auto" src="{{get_the_post_thumbnail_url()}}" alt="portfolio_image">
             </a>
        </li>

        {{-- Large Format --}}
        <li id="portfolioImage" class="relative h-[400px] hidden lg:block select-none flex-grow flex-auto">
            <img class="h-full w-full object-cover cursor-pointer align-middle" src="{{get_the_post_thumbnail_url()}}" alt="portfolio_image">
