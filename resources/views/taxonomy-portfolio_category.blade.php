...
<section>
    <div class="w-full h-full lg:w-lg pt-8 px-4 lg:px-0">
        ...
        <li id="portfolioImage" class="relative h-[400px] w-auto hidden lg:block select-none flex-grow flex-auto contains-img">
            <img width="100%" height="100%" class="h-full w-full object-cover cursor-pointer align-middle transition-opacity duration-200" src="{{get_the_post_thumbnail_url(get_the_ID(), 'portrait')}}" alt="portfolio_image_{{get_the_title()}}">
