    ...
    <div class="w-full h-full lg:w-lg pt-8">
        ...
        <li class="block lg:hidden">
            <a href="{{get_the_post_thumbnail_url()}}" target="_blank">
                <img width="100%" height="100%" class="h-full w-auto" src="{{get_the_post_thumbnail_url(get_the_ID(), 'medium')}}" alt="portfolio_image_{{get_the_title()}}">
             </a>
        </li>

        {{-- Large Format --}}
        <li id="portfolioImage" class="relative h-[400px] w-auto hidden lg:block select-none flex-grow flex-auto contains-img">
            <img width="100%" height="100%" id="jump-{{get_the_ID()}}" class="h-full w-full object-cover cursor-pointer transition-opacity duration-200" src="{{get_the_post_thumbnail_url(get_the_ID(), 'large')}}" alt="portfolio_image_{{get_the_title()}}">
            <div id="portfolioImageLightbox" class="fixed hidden w-full h-full top-0 left-0 z-30 flex justify-center items-center">
                ...
                <div class="relative w-[80vw] h-[80vh] z-30 flex justify-center items-start">
                    <div class="relative h-full flex justify-center items-center">
                        <img width="100%" height="100%" class="w-auto h-full z-40 !opacity-100" src="{{get_the_post_thumbnail_url(get_the_ID(), 'large')}}" alt="portfolio_image_{{get_the_title()}}_lightbox">
