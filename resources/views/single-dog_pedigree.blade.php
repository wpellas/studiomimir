...
<section class="min-h-[100vh] flex justify-center items-center">
            ...
            <div class="pt-8">
                <div class="w-full h-full flex flex-wrap lg:flex-nowrap gap-4">
                    <div class="w-full h-full">
                        ...
                        <div id="singlePedigreeImageBig" class="w-full h-96 lg:min-h-[700px] bg-cover bg-center" style="background-image: url({{$pedigreeImages[0]['pedigree_image']}})">
                ...
                <div class="relative w-full text-left">
                    ...
                    <h5 class="relative lg:absolute bottom-0 text-sm italic text-zinc-800">Ägare: @field('dog_owner')</p>
                        @endif
                    </div>
                </div>
                <div class="w-full pt-4 hidden lg:block">
                    <ul class="flex gap-[6.4px] w-full h-40">
                        ...
                        <li id="singlePedigreeImageSmall" class="w-full h-full bg-cover bg-center hover:opacity-60 cursor-pointer border-primary" style="background-image: url({{$pedigreeImage['pedigree_image']}})"></li>
                        @endforeach
                    </ul>
                </div>
            </div>
    ...
    <p class="pt-8 text-black flex items-center">
