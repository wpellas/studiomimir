<div class="w-full h-full relative flex flex-wrap justify-center my-4 lg:my-8 {{ $block->classes }} {{is_admin() ? "pointer-events-none" : ""}}">
  <div class="w-lg   px-4 lg:px-0 h-full z-10 flex flex-wrap lg:flex-nowrap py-8 gap-8 font-primary">
      <div class=" w-full lg:w-1/2 py-2 lg:py-8 text-center flex flex-wrap justify-center items-stretch gap-4 text-lg">
