        ...
        @hasfields('questions_field')
          ...
          <li id="questionnaire" class="hidden lg:block relative w-full my-4 pb-2 text-primary font-primary list-none">
            <div id="questionnaire_title" class="w-full">
              ...
              @if(!is_admin())
              <i id="questionnaire_arrow" class="fa-solid fa-chevron-down absolute right-2 top-0 select-none cursor-pointer text-2xl transition-all duration-300 hover:animate-pulse ease-in-out"></i>
              @endif
            </div>
